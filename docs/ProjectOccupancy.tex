...
\IEEEauthorblockA{\textit{Department of Computer}\\
		    \textit{Engineering Middle East}\\
			\textit{Technical University, Ankara,}\\
			\textit{Turkey}\\
...
\and
\IEEEauthorblockN{M. Rasit Ozdemir\\}
\IEEEauthorblockA{\textit{Department of Computer}\\
		    \textit{Engineering Middle East}\\
			\textit{Technical University, Ankara,}\\
			\textit{Turkey}\\
...
\IEEEauthorblockN{\hspace{4cm}Zakiah Utami}
\IEEEauthorblockA{\hspace{4cm}\textit{Department of Computer}\\
		    \hspace{4cm}\textit{Engineering Middle East}\\
			\hspace{4cm}\textit{Technical University, Ankara,}\\
			\hspace{4cm}\textit{Turkey}\\
		    \hspace{4cm}utami.zakiah@metu.edu.tr}
\and
\IEEEauthorblockN{\hspace{-1.5cm}Seyda Ertekin}
\IEEEauthorblockA{\hspace{-1.5cm}\textit{Department of Computer}\\
		    \hspace{-1.5cm}\textit{Engineering Middle East}\\
			\hspace{-1.5cm}\textit{Technical University, Ankara,}\\
			\hspace{-1.5cm}\textit{Turkey}\\
		    \hspace{-1.5cm}seyda@ceng.metu.edu.tr}
}
